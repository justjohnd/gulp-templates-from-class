...
gulp.task("watch", function() {
  ...
  gulp.watch(filesPath.sass, gulp.task("sass")).on("change", browserSync.reload);
  gulp.watch(filesPath.less, gulp.task("less")).on("change", browserSync.reload);
  gulp.watch(filesPath.js, gulp.task("javascript")).on("change", browserSync.reload);
  gulp.watch(filesPath.html, gulp.task("kit")).on("change", browserSync.reload);
  gulp.watch(filesPath.images, gulp.task("imagemin")).on("change", browserSync.reload);
});
